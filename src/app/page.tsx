    ...
    <main className="min-h-screen items-center flex-col justify-center">
      <div className="bg-lime-500 p-12 flex justify-center">
        <div className="max-w-5xl items-center text-center">
          ...
          <p className="text-white p-5"><strong>Ola!</strong>  I'm an AI-Powered meal generator to help you create quick meals based on your preference such as allergens, diet restrictions, your calorie intake or even whatever is available in your kitchen.</p>
        </div>
      </div>
      <div className="flex justify-center">
        <div className="max-w-5xl flex items-center text-center min-h-80 py-12">
          <div className="w-full px-5">
            <h3 className="text-stone-400 p-5 font-bold">{sectionTitle}</h3>
