...
<div className="flex items-end flex-col font-[sans-serif] max-w-[250px]">
      <div className="flex items-start">
        <div className="mr-6">
          ...
          <h6 className="text-lg font-bold text-[#333]">Basic details</h6>
        </div>
      ...
      <div className="flex items-start">
        <div className="mr-6">
          ...
          <h6 className="text-lg font-bold text-[#333]">Education details</h6>
        </div>
        <div className="flex flex-col items-center">
          <div
            className="w-8 h-8 shrink-0 mx-[-1px] border-2 border-green-500 p-1.5 flex items-center justify-center rounded-full">
      ...
      <div className="flex items-start">
        <div className="mr-6">
          <p className="text-[10px] font-bold text-gray-400">STEP 2</p>
          <h6 className="text-lg font-bold text-[#333]">Company details</h6>
        </div>
        <div className="flex flex-col items-center">
          <div
            className="w-8 h-8 shrink-0 mx-[-1px] border-2 border-gray-300 p-1.5 flex items-center justify-center rounded-full">
